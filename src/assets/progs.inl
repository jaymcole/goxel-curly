...
{.path = "data/progs/cherry.goxcf", .size = 495, .data =
    "shape main {\n"
    "    [seed 7]\n"
...
{.path = "data/progs/city.goxcf", .size = 1273, .data =
    "shape main {\n"
    "    [seed 4]\n"
    "    city[]\n"
    "}\n"
...
{.path = "data/progs/intro.goxcf", .size = 2652, .data =
...
{.path = "data/progs/planet.goxcf", .size = 549, .data =
    "// Simple planet\n"
    "shape main {\n"
    "    [s 50]\n"
...
{.path = "data/progs/test.goxcf", .size = 346, .data =
    "// Simple Test\n"
    "\n"
    "shape branch\n"
    "rule {\n"
...
{.path = "data/progs/test2.goxcf", .size = 436, .data =
    "shape main {\n"
    "    [antialiased 1]\n"
...
{.path = "data/progs/test3.goxcf", .size = 322, .data =
    "shape main {\n"
    "   [antialiased 1]\n"
    "   loop 8 [rz 45] {\n"
    "       test [s 20 x 2]\n"
...
{.path = "data/progs/tree-big.goxcf", .size = 571, .data =
    "\n"
    "shape leaf {\n"
    "    cube[]\n"
...
{.path = "data/progs/tree-small.goxcf", .size = 397, .data =
    "shape branch2 {\n"
    "    cube[]\n"
