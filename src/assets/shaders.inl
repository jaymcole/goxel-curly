...
{.path = "data/shaders/background.glsl", .size = 597, .data =
...
{.path = "data/shaders/model3d.glsl", .size = 2853, .data =
...
{.path = "data/shaders/pos_data.glsl", .size = 821, .data =
...
{.path = "data/shaders/shadow_map.glsl", .size = 663, .data =
    "#ifdef VERTEX_SHADER\n"
    "\n"
    "/************************************************************************/\n"
    "attribute highp   vec3  a_pos;\n"
...
{.path = "data/shaders/volume.glsl", .size = 9737, .data =
    "/* Goxel 3D voxels editor\n"
    " *\n"
